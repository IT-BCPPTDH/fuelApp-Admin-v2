...
const ModalBulkOperator = () => {
    ...
    const handleImport = async() => {
      ...
      try {
        ...
        const response = await bulkMasterData.bulkOperator(formData);
  ...
  const handleDownloadTemplate = () => {
    const template = 'mdOperator_template.xlsx'
...
export default ModalBulkOperator;
