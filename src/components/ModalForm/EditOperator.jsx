...
const ModalEditOperator = ({row}) => {
  ...
  const handleDelete = async () => {
    try {
      const res = await OperatorService.delOperators(row.id);
      if (res.status === '200') {
    ...
    <>
     <EuiButtonIcon iconType="pencil" aria-label="Edit" onClick={() => setIsModalVisible(true)}>Edit</EuiButtonIcon>
      {isModalVisible && (
        ...
        >
          <EuiModalHeader>
            <EuiModalHeaderTitle id={modalTitleId}> Edit Operator</EuiModalHeaderTitle>
          </EuiModalHeader>
          <EuiModalBody>
          <EuiForm id={modalFormId} component="form">
              <EuiFlexGrid columns={2}>
                ...
                <EuiFormRow label="Fullname" style={{marginTop:"0px"}}>
                  <EuiFieldText 
                      name='fullname'
                ...
                <EuiFormRow label="Division" style={{marginTop:"0px"}}>
                <EuiFieldText 
                      name='division'
