...
const HoursMeterPage = () => {
    ...
    return(<>
        <HeaderPageForm
          title={HeaderTitle.HOUR_METER}
          urlCreate={NavigateUrl.HOUR_METER_DATA_ENTRY}
          urlBack={NavigateUrl.HOME}
          buttonText={ButtonText.FRM_HOUR_METER}
        />
        <div className="row">
