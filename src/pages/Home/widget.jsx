...
const CardContent = () => {
  ...
  const cardsData = [
    { title: summary.prevSonding ? summary.prevSonding + ' cm' : 0 + ' cm', description1: 'Previous Close Sonding', description2: 'Total close sonding', icon: Icon1 },
    { title: summary.openSonding ? summary.openSonding + ' cm' : 0 + ' cm', description1: 'Open Stock (Sonding)', description2: 'Summary Open Sonding', icon: Icon1 },
    ...
    { title: summary.closeSonding ? summary.closeSonding + ' cm': 0 + ' cm', description1: 'Close Sonding', description2: 'Total Close Sonding ', icon: Icon3 },
    ...
    { title: summary.intershiftNtoD ? summary.intershiftNtoD + ' Ltrs' : 0 + ' Ltrs', description1: 'Total Intershift (N to D)', description2: 'Total close sonding ', icon: Icon4 },
  ];
